...
import { auditType7Quantile, type7Quantile, TYPE7_QUANTILE_SCHEMA } from "./a13_stat_rounding_near_grid_v5_quantile";
import {
...
const SCHEMA = "heroes-of-crypto/a13-stat-rounding-near-grid-replication/v4" as const;
const CAPTURE_SCHEMA = "heroes-of-crypto/a13-stat-rounding-near-grid-pair/v3" as const;
...
const CAMPAIGN_SCHEMA = "heroes-of-crypto/a13-stat-rounding-near-grid-campaign/v3" as const;
const CAMPAIGN_ID = "a13-stat-rounding-near-grid-77ee4616-20260723-v6" as const;
...
const CAPTURE_RUNNER_SHA256 = "50c51dae00711664ea73b9135d194a513fbeb07f51aeb5bbeb5e94695ad28d4d";
const MICRO_RUNNER_SHA256 = "cf65c2e6811017375f0f4c6217933f0148c0fc5ee594579c355ad4cd5908480f";
const PROFILE_RUNNER_SHA256 = "11e006700540488b8a20a8fc8039210190adcfbe2a81f0d0f93a5ba8aceb31e4";
const MICRO_SOURCE_MANIFEST_SHA256 = CANDIDATE_SRC_MANIFEST_SHA256;
const MICRO_RUNTIME_DEPENDENCY_MANIFEST_CODEC =
    "heroes-of-crypto/a13-stat-rounding-near-grid-micro-manifest/type-tagged-v1";
...
const PRODUCER_MANIFESTS = Object.freeze({
    ...
    micro: {
        sourceManifest: {
            ...
            entryCount: 372,
            bytes: 10_011_554,
            manifestSha256: MICRO_SOURCE_MANIFEST_SHA256,
        },
        identityCodec: "heroes-of-crypto/a13-stat-rounding-near-grid-micro-run-seal/sorted-json-v1",
        runtimeDependencyManifestCodec: MICRO_RUNTIME_DEPENDENCY_MANIFEST_CODEC,
        runtimeDependencies: {
            denque: {
                entryCount: 6,
                bytes: 30_361,
...
const PAIR_RUNNER_PATH = resolve(dirname(RUNNER_PATH), "a13_stat_rounding_near_grid_v6_pair.ts");
const MICRO_RUNNER_PATH = resolve(dirname(RUNNER_PATH), "a13_stat_rounding_near_grid_v6_micro.ts");
const PROFILE_RUNNER_PATH = resolve(dirname(RUNNER_PATH), "a13_stat_rounding_near_grid_v5_profile.ts");
const CAMPAIGN_RUNNER_PATH = resolve(dirname(RUNNER_PATH), "a13_stat_rounding_near_grid_v6_campaign.ts");
const QUANTILE_HELPER_PATH = resolve(dirname(RUNNER_PATH), "a13_stat_rounding_near_grid_v5_quantile.ts");
const SOURCE_MANIFEST_HELPER_PATH = resolve(dirname(RUNNER_PATH), "a13_stat_rounding_near_grid_v6_source_manifest.ts");
...
const EXPECTED_DEVELOPMENT_PROVENANCE = Object.freeze({
    ...
    v5InfrastructureIncident: {
        campaignId: "a13-stat-rounding-near-grid-77ee4616-20260723-v5",
        outcome: "infrastructure-invalid-after-accepted-semantic-before-micro-measurement",
        semanticArtifactSha256: "7b6e8050583eeecd9cecea5fb7b10a0aadd00325b214403cacd9d600b7ff6db1",
        semanticExactnessPassed: true,
        semanticTaskPairs: 160,
        semanticMatches: 320,
        semanticTotalRatio: 0.9082936001296996,
        timingDisposition: "development-provenance-only-read-for-binding-never-used-or-pooled-for-qualification",
        microProfileMacroOrAggregateEvidenceProduced: false,
    },
    freshEvidencePolicy: {
        freshV6TimingsOnly: true,
        predecessorTimingReadByV6Runners: false,
        predecessorTimingPooled: false,
        predecessorArtifactsAcceptedAsInputs: false,
        v4InfrastructureLogsReadOnlyForDiagnosis: true,
        v4PerformanceDataAvailable: false,
        v4ArtifactsAcceptedAsInputs: false,
        v5InfrastructureRecordReadOnlyForDiagnosis: true,
        v5SemanticArtifactAcceptedAsInput: false,
        v5SemanticArtifactReadByV6Runners: false,
        v5SemanticTimingReadOnlyForProvenanceValidation: true,
        v5SemanticTimingUsedForQualification: false,
        v5SemanticTimingPooled: false,
        v5MicroProfileMacroOrAggregateArtifactsAcceptedAsInputs: false,
...
const SOURCE_DEPENDENCY_PREFLIGHT = Object.freeze({
    schema: "heroes-of-crypto/a13-stat-rounding-near-grid-source-dependency-preflight/v2",
    executionBoundary:
    ...
    expectedRoots: {
        baseline: "/private/tmp/hoc-stat-rounding-near-grid-v6-qualification.wfNoyf/baseline",
        candidate: "/private/tmp/hoc-stat-rounding-near-grid-v6-qualification.wfNoyf/candidate",
    },
    sourceArchives: {
        baseline: {
            path: "/private/tmp/hoc-stat-rounding-near-grid-v6-qualification.wfNoyf/baseline.tar",
            sha256: BASELINE_ARCHIVE_SHA256,
            srcTreeManifestSha256: BASELINE_SRC_MANIFEST_SHA256,
        },
        candidate: {
            path: "/private/tmp/hoc-stat-rounding-near-grid-v6-qualification.wfNoyf/candidate.tar",
    ...
    microSourceManifest: {
        ...
        baseline: {
            ...
            entryCount: 371,
            bytes: 10_004_717,
            manifestSha256: BASELINE_SRC_MANIFEST_SHA256,
        },
        candidate: {
            schema: A13_NEAR_GRID_SOURCE_MANIFEST_SCHEMA,
            pathScope: A13_NEAR_GRID_SOURCE_MANIFEST_PATH_SCOPE,
            ...
            entryCount: 372,
            bytes: 10_011_554,
            manifestSha256: CANDIDATE_SRC_MANIFEST_SHA256,
        },
        liveCommonRootMustEqualCandidate: true,
    },
    nodeModules: {
        requiredLiteralLinkTarget:
            "/Users/zolotukhin/Workplace/heroes-of-crypto-client/game/heroes-of-crypto-common/node_modules",
        requiredRealPath:
            "/Users/zolotukhin/Workplace/heroes-of-crypto-client/game/heroes-of-crypto-common/node_modules",
    },
    workspaceLock: {
        path: "/Users/zolotukhin/Workplace/heroes-of-crypto-client/bun.lock",
        realPath: "/Users/zolotukhin/Workplace/heroes-of-crypto-client/bun.lock",
        bytes: 438_981,
...
function commandLine(): ICli | undefined {
    ...
    if (values.help) {
        console.log(
            "Usage: bun docs/evidence/tools/a13_stat_rounding_near_grid_v6_replication.ts " +
...
function loadProtocol(): { value: Record<string, unknown>; seal: IFileSeal } {
    ...
    assertEqual(value.sourceDependencyPreflight, SOURCE_DEPENDENCY_PREFLIGHT, "protocol source/dependency preflight");
    const incidentSeal = fileSeal(INCIDENT_PATH);
    assertEqual(
        value.v5InfrastructureIncident,
        {
            schema: "heroes-of-crypto/a13-stat-rounding-near-grid-v5-infrastructure-incident/v1",
            incident: {
                path: "docs/evidence/a13_stat_rounding_near_grid_v5_infrastructure_incident_2026-07-23.json",
                sha256: incidentSeal.sha256,
            },
            outcome: "infrastructure-invalid-after-accepted-semantic-before-micro-measurement",
    ...
    assertEqual(
        value.quantileImplementation,
        {
            ...
            helper: {
                path: "docs/evidence/tools/a13_stat_rounding_near_grid_v5_quantile.ts",
    ...
    assertEqual(
        value.stoppingRule,
        {
            ...
            formalPreflightFailure:
                "Any failure of the frozen source/dependency checks or the actual micro --source-preflight-only subprocess before output creation terminates v6 and authorizes no retry or empirical artifact.",
            performanceFailure:
    ...
    const expectedRunners = {
        ...
        sourceManifest: {
            schema: A13_NEAR_GRID_SOURCE_MANIFEST_SCHEMA,
            sha256: fileSeal(SOURCE_MANIFEST_HELPER_PATH).sha256,
        },
    };
...
function validateMicro(path: string, protocol: Record<string, unknown>): IValidatedMicro {
    ...
    const microSourceManifestHelper = requireRecord(sourceBefore.sourceManifestHelper, "micro source manifest helper");
    assertEqual(
        microSourceManifestHelper,
        {
            ...fileSeal(SOURCE_MANIFEST_HELPER_PATH),
            path: relative(COMMON_ROOT, SOURCE_MANIFEST_HELPER_PATH).split(sep).join("/"),
        },
        "micro source manifest helper seal",
    );
    const expectedMicroSourceManifest = requireRecord(microManifests.sourceManifest, "protocol micro source manifest");
    const observedMicroSourceManifest = requireRecord(sourceBefore.source, "micro source manifest");
    assertEqual(
        {
            schema: observedMicroSourceManifest.manifestSchema,
            pathScope: observedMicroSourceManifest.manifestPathScope,
            comparator: observedMicroSourceManifest.manifestComparator,
            entryCount: observedMicroSourceManifest.entries,
            bytes: observedMicroSourceManifest.bytes,
            manifestSha256: observedMicroSourceManifest.manifestSha256,
        },
        expectedMicroSourceManifest,
        "micro source manifest identity",
    );
    assertEqual(
    ...
    for (const dependencyName of ["denque", "google-protobuf"] as const) {
        ...
        assertEqual(
            dependency.manifestCodec,
            MICRO_RUNTIME_DEPENDENCY_MANIFEST_CODEC,
            `micro ${dependencyName} manifest codec`,
        );
    ...
    assertEqual(
        microDependencyEnvelope.manifestCodec,
        MICRO_RUNTIME_DEPENDENCY_MANIFEST_CODEC,
        "micro dependency manifest codec",
    );
    ...
    assertEqual(
        frozenRuntimeBefore.manifestCodec,
        MICRO_RUNTIME_DEPENDENCY_MANIFEST_CODEC,
        "micro runtime manifest codec",
    );
    ...
    assertEqual(
        {
            schema: frozenBefore.expectedSrcManifestSchema,
            pathScope: frozenBefore.expectedSrcManifestPathScope,
            comparator: frozenBefore.expectedSrcManifestComparator,
            entryCount: frozenBefore.expectedSrcEntries,
            bytes: frozenBefore.expectedSrcBytes,
            manifestSha256: frozenBefore.expectedSrcManifestSha256,
        },
        expectedMicroSourceManifest,
        "micro expected manifest identity",
    );
    assertEqual(frozenBefore.observedSrcManifestSchema, expectedMicroSourceManifest.schema, "micro observed schema");
    assertEqual(
        frozenBefore.observedSrcManifestPathScope,
        expectedMicroSourceManifest.pathScope,
        "micro observed scope",
    );
    assertEqual(
        frozenBefore.observedSrcManifestComparator,
        expectedMicroSourceManifest.comparator,
        "micro observed comparator",
    );
    assertEqual(frozenBefore.observedSrcEntries, expectedMicroSourceManifest.entryCount, "micro observed entries");
    assertEqual(frozenBefore.observedSrcBytes, expectedMicroSourceManifest.bytes, "micro observed bytes");
...
function validateLedger(
    ...
    assertEqual(
        frozen.sourceDependencyPreflight,
        protocol.sourceDependencyPreflight,
        "ledger frozen source/dependency preflight",
    );
    validateRecordedFileSeal(
        requireRecord(frozen.v5InfrastructureIncident, "ledger frozen v5 incident"),
        INCIDENT_PATH,
        "ledger frozen v5 incident",
    );
    ...
    for (const [name, expectedPath] of [
        ...
        ["sourceManifest", SOURCE_MANIFEST_HELPER_PATH],
    ] as const) {
    ...
    for (const committedFile of [
        ...
        ...["campaign", "pair", "micro", "profile", "replication", "quantile", "sourceManifest"].map((name) => {
