 ...
 *
 * Evidence run:
 *   bun docs/evidence/tools/a13_stat_rounding_near_grid_profile.ts \
...
const SCHEMA = "heroes-of-crypto/a13-stat-rounding-near-grid-profile/v2" as const;
...
async function orchestrate(args: string[]): Promise<void> {
    ...
    if (values.help) {
        console.log(
            "Usage: bun docs/evidence/tools/a13_stat_rounding_near_grid_profile.ts " +
