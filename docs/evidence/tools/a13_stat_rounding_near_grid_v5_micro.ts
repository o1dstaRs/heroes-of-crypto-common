 ...
 *
 * Evidence:
 *   bun docs/evidence/tools/a13_stat_rounding_near_grid_v5_micro.ts \
...
const SCHEMA = "heroes-of-crypto/a13-stat-rounding-near-grid-micro/v4" as const;
...
function commandLine(): ICli {
    ...
    if (values.help) {
        console.log(
            "Usage: bun docs/evidence/tools/a13_stat_rounding_near_grid_v5_micro.ts " +
