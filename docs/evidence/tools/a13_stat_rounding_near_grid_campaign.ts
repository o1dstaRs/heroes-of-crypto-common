...
import { auditType7Quantile, TYPE7_QUANTILE_SCHEMA } from "./a13_stat_rounding_near_grid_quantile";

const SCHEMA = "heroes-of-crypto/a13-stat-rounding-near-grid-campaign/v1" as const;
...
const PAIR_SCHEMA = "heroes-of-crypto/a13-stat-rounding-near-grid-pair/v2" as const;
...
const REPLICATION_SCHEMA = "heroes-of-crypto/a13-stat-rounding-near-grid-replication/v2" as const;
const CAMPAIGN_ID = "a13-stat-rounding-near-grid-77ee4616-20260723-v4";
...
const PAIR_PATH = resolve(dirname(RUNNER_PATH), "a13_stat_rounding_near_grid_pair.ts");
const MICRO_PATH = resolve(dirname(RUNNER_PATH), "a13_stat_rounding_near_grid_micro.ts");
const PROFILE_PATH = resolve(dirname(RUNNER_PATH), "a13_stat_rounding_near_grid_profile.ts");
const REPLICATION_PATH = resolve(dirname(RUNNER_PATH), "a13_stat_rounding_near_grid_replication.ts");
const QUANTILE_PATH = resolve(dirname(RUNNER_PATH), "a13_stat_rounding_near_grid_quantile.ts");
