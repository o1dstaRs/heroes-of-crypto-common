...
const CANDIDATE_GIT_TREE = "5c7cefd52f27e6344ed8902a1b5f90eb3caba0da";
const BASELINE_SRC_MANIFEST_SHA256 = "076d0689decdfbb071c9632a05103d10bc7181e34500f980bae3c58433398370";
const CANDIDATE_SRC_MANIFEST_SHA256 = "bceb951f49bcddd5cf63e3a5e3b3e5f77f1bbef96965e3bb66b4ff622eab0043";
const PROFILE_BASELINE_SRC_MANIFEST_SHA256 = "73f78af822eace14fbe63c22115922732e0255b431a24403bc8ec794aaf98369";
const PROFILE_CANDIDATE_SRC_MANIFEST_SHA256 = "033f499edbefb61491d1c49b8f49be7b480f7b0592795eca6dee207ba16dbdfa";
const BASELINE_ARCHIVE_SHA256 = "bd8de4690d92d6c0a952ded8fb8f66c3dafec404bb47a4f9b2c597b757cc5e2a";
const CANDIDATE_ARCHIVE_SHA256 = "449e57bdb30e12b5f046ba1956187bc573d732608eb4f8a3ef888d727e8bf3a2";
...
const CAPTURE_RUNNER_SHA256 = "03ec0f9668bb5ff77b33cdf713d0a26129aca8a4676af4233680f9f9b48a06cc";
const MICRO_RUNNER_SHA256 = "dcf4b64d618e90749fef003db6dae59c01df4952d858c0008a2f80d7b169440a";
const PROFILE_RUNNER_SHA256 = "094536747bad281eb2bfb3763690c3e2d12b7ef22e01d1df6c1d4d59738b1711";
const MICRO_SOURCE_MANIFEST_SHA256 = "86ba3f5d3cb5ae74cca97ec21fd5031b43094975337a3ae12f2c2f2c223361a0";
const MICRO_MANIFEST_CODEC = "heroes-of-crypto/a13-stat-rounding-micro-manifest/type-tagged-v1";
...
const PRODUCER_MANIFESTS = Object.freeze({
    ...
    micro: {
        sourceCodec: "heroes-of-crypto/a13-stat-rounding-micro-source/sorted-json-v1",
        identityCodec: "heroes-of-crypto/a13-stat-rounding-micro-run-seal/sorted-json-v1",
    ...
    profile: {
        codec: "heroes-of-crypto/a13-stat-rounding-profile-manifest/sorted-json-array-v1",
        identityCodec: "heroes-of-crypto/a13-stat-rounding-profile-identity/type-tagged-v1",
...
const CAMPAIGN_RUNNER_PATH = resolve(dirname(RUNNER_PATH), "a13_stat_rounding_campaign.ts");
const EXPECTED_RUNTIME_DELTA = Object.freeze([
    ...
    },
    {
        ...
        change: "added",
        baselineSha256: null,
        candidateSha256: "7c083c28e8ced495c5ae78d45979daf61ef9793e4bacbf1d25392ecf87897613",
    },
    {
        path: "units/unit.ts",
        change: "modified",
...
const EXPECTED_OVERLAP_MARKERS = Object.freeze([
    "a13_stat_rounding_pair",
    "a13_stat_rounding_micro",
    "a13_stat_rounding_profile",
    "a13_stat_rounding_replication",
    "a13_stat_rounding_campaign",
    "run_tournament.ts",
    "run_match.ts",
...
function validateHostAttestation(
    ...
    assertEqual(attestation.schema, "heroes-of-crypto/a13-stat-rounding-host-attestation/v1", `${label} schema`);
...
function validateHostHealthSample(value: unknown, label: string): Record<string, unknown> {
    ...
    assertEqual(sample.schema, "heroes-of-crypto/a13-stat-rounding-host-health/v1", `${label} schema`);
...
function validateLedger(
    ...
    const expectedRecordCount = 2 + REQUIRED_LEDGER_STAGES.length * 2 + 1;
    ...
    for (const committedFile of [
        protocolSeal,
        ...["campaign", "pair", "micro", "profile", "replication"].map((name) => {
