...
describe("Battle Mage spell configuration", () => {
    ...
    // pays for an OFFENSIVE book by sitting at or below them on the defensive stats.
    it("sits at or below the weakest level 2 casters on armor and health", () => {
        ...
        expect(battleMage.hp).toBeLessThanOrEqual(Math.max(healer.hp, satyr.hp));
    });
});
