...
describe("spell_helper", () => {
    ...
    it("calculates buff and debuff stat effects", () => {
        ...
        expect(
            calculateBuffsDebuffsEffect([], [new AppliedSpell("Helping Hand", 0, 3, 50, 10)]).baseStats,
        ).toEqual({
            hp: -15,
            armor: -3,
            luck: 0,
...
function customSpell(name: string, targetType: SpellTargetType, isBuff: boolean): Spell {
    return new Spell({
