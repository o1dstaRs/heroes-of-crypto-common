...
describe("v0.8 a13 production profile", () => {
    ...
    it("constructs an exact bounded driver and restores hostile ambient experiments", () => {
        ...
        process.env.V08_SUPPORTED_BAND_ADVANCE_DOMINANCE_OVERLAY_CONTROL_VERSIONS = "v0.4";
        process.env.V08_SUPPORTED_BAND_ADVANCE_DOMINANCE_OVERLAY_VERSIONS = "v0.5";
        process.env.V08_SUPPORTED_BAND_ADVANCE_OVERLAY_CONTROL_VERSIONS = "v0.5";
        process.env.V08_SUPPORTED_BAND_ADVANCE_OVERLAY_VERSIONS = "v0.6";
        process.env.V08_SUPPORTED_BAND_ADVANCE_VERSIONS = "v0.7";
        process.env.V08_SUPPORTED_BAND_DECISIVE_SCREENED_CLOSER_OVERLAY_CONTROL_VERSIONS = "v0.2";
        process.env.V08_SUPPORTED_BAND_DECISIVE_SCREENED_CLOSER_OVERLAY_VERSIONS = "v0.3";
        process.env.V08_SUPPORTED_BAND_SCREENED_CLOSER_OVERLAY_CONTROL_VERSIONS = "v0.4";
        process.env.V08_SUPPORTED_BAND_SCREENED_CLOSER_OVERLAY_VERSIONS = "v0.5";
        ...
        expect(process.env.V08_SUPPORTED_BAND_ADVANCE_DOMINANCE_OVERLAY_CONTROL_VERSIONS).toBe("v0.4");
        expect(process.env.V08_SUPPORTED_BAND_ADVANCE_DOMINANCE_OVERLAY_VERSIONS).toBe("v0.5");
        expect(process.env.V08_SUPPORTED_BAND_ADVANCE_OVERLAY_CONTROL_VERSIONS).toBe("v0.5");
        expect(process.env.V08_SUPPORTED_BAND_ADVANCE_OVERLAY_VERSIONS).toBe("v0.6");
        expect(process.env.V08_SUPPORTED_BAND_ADVANCE_VERSIONS).toBe("v0.7");
        expect(process.env.V08_SUPPORTED_BAND_DECISIVE_SCREENED_CLOSER_OVERLAY_CONTROL_VERSIONS).toBe("v0.2");
        expect(process.env.V08_SUPPORTED_BAND_DECISIVE_SCREENED_CLOSER_OVERLAY_VERSIONS).toBe("v0.3");
        expect(process.env.V08_SUPPORTED_BAND_SCREENED_CLOSER_OVERLAY_CONTROL_VERSIONS).toBe("v0.4");
        expect(process.env.V08_SUPPORTED_BAND_SCREENED_CLOSER_OVERLAY_VERSIONS).toBe("v0.5");
