...
<main class="shell report-main">
  ...
  <section aria-labelledby="leaders-title">
    <div class="section-head"><div><p class="eyebrow">At a glance</p><h2 id="leaders-title">Category leaders</h2></div><p>Highest observed draw-aware score rate in the selected cohort and map set. Treat close results as a tier rather than a proven unique winner: confidence intervals can overlap, and the augment-plan view compares 96 candidates.</p></div>
    <div class="leaders" id="leaders"></div>
  </section>

  <section aria-labelledby="rankings-title">
    <div class="section-head"><div><p class="eyebrow">Comparative performance</p><h2 id="rankings-title">Score-rate forest plots</h2></div><p>The selected cohort and map set apply to every chart. The unit panel includes every reported unit and its level; the gold rule marks 50%, and whiskers show reported 95% intervals.</p></div>
  ...
  <section aria-labelledby="table-title">
    <div class="section-head"><div><p class="eyebrow">Audit the numbers</p><h2 id="table-title">Full rankings</h2></div><p>Search any unit or item within the selected cohort and map, restrict by category, and sort on every reported metric.</p></div>
