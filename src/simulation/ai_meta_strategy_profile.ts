...
export type AiMetaStrategyProfileId =
    typeof AI_META_REGISTERED_VERSION_STRATEGY_PROFILE | typeof AI_META_A19_H18_RANKED_PLACEMENT_STRATEGY_PROFILE;
 ...
 * preserving the version registry's existing behavior. The placement arm receives two independent decorators
 * because placement audits and any future strategy-local state must never leak between seats or matches.
 */
