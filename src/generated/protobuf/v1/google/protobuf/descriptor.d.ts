...
export declare namespace google.protobuf {
    ...
    class FieldOptions extends pb_1.Message {
        ...
        set features(value: FeatureSet);
        get has_features(): boolean;
        get feature_support(): FieldOptions.FeatureSupport;
        set feature_support(value: FieldOptions.FeatureSupport);
        get has_feature_support(): boolean;
        get uninterpreted_option(): UninterpretedOption[];
        set uninterpreted_option(value: UninterpretedOption[]);
        static fromObject(data: {
            ctype?: FieldOptions.CType;
    ...
    namespace FieldOptions {
        ...
        class FeatureSupport extends pb_1.Message {
            ...
            get edition_introduced(): Edition;
            set edition_introduced(value: Edition);
            get has_edition_introduced(): boolean;
            get edition_deprecated(): Edition;
            set edition_deprecated(value: Edition);
            get has_edition_deprecated(): boolean;
            get deprecation_warning(): string;
            set deprecation_warning(value: string);
            get has_deprecation_warning(): boolean;
            get edition_removed(): Edition;
            set edition_removed(value: Edition);
            get has_edition_removed(): boolean;
            get removal_error(): string;
            set removal_error(value: string);
            get has_removal_error(): boolean;
            static fromObject(data: {
                edition_introduced?: Edition;
                edition_deprecated?: Edition;
                deprecation_warning?: string;
    ...
    class FeatureSet extends pb_1.Message {
        ...
        get enforce_naming_style(): FeatureSet.EnforceNamingStyle;
        set enforce_naming_style(value: FeatureSet.EnforceNamingStyle);
        get has_enforce_naming_style(): boolean;
        get default_symbol_visibility(): FeatureSet.VisibilityFeature.DefaultSymbolVisibility;
        set default_symbol_visibility(value: FeatureSet.VisibilityFeature.DefaultSymbolVisibility);
        get has_default_symbol_visibility(): boolean;
        static fromObject(data: {
            field_presence?: FeatureSet.FieldPresence;
            enum_type?: FeatureSet.EnumType;
            repeated_field_encoding?: FeatureSet.RepeatedFieldEncoding;
    ...
    namespace FeatureSetDefaults {
        class FeatureSetEditionDefault extends pb_1.Message {
            ...
            set edition(value: Edition);
            get has_edition(): boolean;
            get overridable_features(): FeatureSet;
            set overridable_features(value: FeatureSet);
            get has_overridable_features(): boolean;
            get fixed_features(): FeatureSet;
            set fixed_features(value: FeatureSet);
            get has_fixed_features(): boolean;
            static fromObject(data: {
                edition?: Edition;
