...
// scouting trade-off: it sets BOTH how much of the opponent's draft you can see AND your upgrade
...
export interface PerkProperties {
    ...
    // Key into game/core image_imports (perk_scout / perk_spymaster / perk_blind_fury).
