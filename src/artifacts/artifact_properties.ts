...
export enum Tier1Artifact {
    ...
    AEGIS_SHIELD = 12, // +15% defense vs area attacks
}
...
export const ARTIFACT_POWER = {
    ...
    HELM_OF_FOCUS_RESIST_PERCENT: 25,
...
export const TIER1_ARTIFACTS: { [key in Tier1Artifact]: ArtifactProperties } = {
    ...
    [Tier1Artifact.SWIFT_BOOTS]: t1(
        ...
        "Swift Boots",
        "Swift Boots",
        "Grants +{} movement to melee units.",
    ),
    ...
    [Tier1Artifact.AEGIS_SHIELD]: t1(
        ...
        "Aegis Shield",
        "Aegis Shield",
        "Reduces damage taken from area attacks by {}%.",
    ),
};
